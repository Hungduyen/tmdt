			                ...
			                <div class="section-detail">
			                        <div class="form-row clearfix">
			                            <div class="form-col fl-left">
			                                ...
			                                <input type="text" placeholder="Mời nhập tài khoản" name="username" id="fullname">
			                            </div> 
			                        </div>
			                        <div class="form-row clearfix">
			                            <div class="form-col fl-left">
			                                <label for="address">Mật khẩu</label>
			                                <input style="height: 38px;width: 250px;border: 1px solid #cccccc;" type="password" placeholder="Mời nhập mật khẩu" name="password" id="address">
			                            </div>
			                        </div>
			                </div>
            ...
            <div class="section-detail">
                <form method="POST" action="?modules=users&controllers=index&action=crateAcount" name="form-checkout">
	                    <div class="form-row clearfix">
	                        <div class="form-col fl-left">
	                            <label for="fullname">Tên đăng nhập</label>
	                            <input type="text" placeholder="Mời nhập tên đăng nhập" name="username" id="fullname">
	                        </div>
	                        <div class="form-col fl-right">
	                            <label for="email">Mật khẩu</label>
	                            <input style="height: 38px;width: 275px;border: 1px solid #cccccc;" type="password" placeholder="Mời nhập mật khẩu" name="password" id="email">
	                        </div>
	                    </div>
	                    <div class="form-row clearfix">
	                        <div class="form-col fl-left">
	                            <label for="address">Email</label>
	                            <input type="text" placeholder="Mời nhập email" name="mail" id="address">
	                        </div>
	                        <div class="form-col fl-right">
	                            <label for="phone">Số điện thoại</label>
	                            <input type="tel" placeholder="Mời nhập số điện thoại" name="phone" id="phone">
	                        </div>
	                    </div>
	                    <div class="form-row">
	                    	<label for="phone">Họ và tên</label>
	                            ...
	                            placeholder="Mời nhập họ và tên" name="fullname" id="">
	                        <div class="form-col">
	                            <label for="notes">Địa chỉ</label>
	                            <textarea placeholder="Mời nhập địa chỉ" name="address"></textarea>
	                        </div>
	                    </div>
