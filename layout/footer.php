    ...
    <div id="foot-body">
        <div class="wp-inner clearfix">
            ...
            <div class="block menu-ft" id="info-shop">
                ...
                <ul class="list-item">
                    <li>
                        <p>40 Cao Thắng phường Thanh Bình quận Hải Châu thành phố Đà Nẵng</p>
                    </li>
                    <li>
                        <p>0335309844</p>
                    </li>
            ...
            <div class="block" id="newfeed">
                ...
                <p class="desc">Đến với chúng tôi để có những sản phẩm tốt nhất cho bạn</p>
                <div id="form-reg">
...
<div id="menu-respon">
    <a href="?page=home" title="" class="logo">Trang Chủ</a>
